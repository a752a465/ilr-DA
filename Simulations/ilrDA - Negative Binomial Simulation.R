#################################################################################################################
### Title: ilr-DA: Negative Binomial Simulation V1 ----
...
sim_config <- list(
  ...
  n_perm = n_perm,data_function=data_function
)
...
if(save_results==TRUE){
  write_xlsx(Model_Results_Complete,path=paste0(Results_path,"NegativeBino_",gsub("-","_",Sys.Date()),".xlsx"))
}
Model_Results_Complete_Cell = Model_Results_Complete
